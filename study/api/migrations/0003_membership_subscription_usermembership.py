# Generated by Django 3.1.5 on 2021-03-10 03:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('api', '0002_remove_user_id_from_lessons_model'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('membership', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_membership', to='api.membership')),
